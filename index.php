...
<body class="flex-shrink-0" style="--bs-body-bg: #f2f3f3;">
    ...
    <form action="index.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <div class="row">
           ...
           <iframe title="Report Section" width="1024" height="612" src="https://app.powerbi.com/view?r=eyJrIjoiYTFiZDdmOGYtMGExYy00OGJmLWFiMTctNTY2MjQxNTdmNTg4IiwidCI6Ijc2MTIxOTIxLTIwNGUtNDE4OC05NDVjLWYwZDA1YmU1NWUwZiIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe> 
        </div>
    </form>  
    </div>
