...
<body class="flex-shrink-0" style="--bs-body-bg: #f2f3f3;">
    ...
    <form action="index.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <div class="row">
           ...
           <iframe title="w" width="1024" height="760" src=<iframe title="forcaset" width="600" height="373.5" src="https://app.powerbi.com/view?r=eyJrIjoiZWZlNGVlNjgtOTU1MS00ZTU1LWEyYjgtNjhmYzk5OTU1YzRkIiwidCI6Ijc2MTIxOTIxLTIwNGUtNDE4OC05NDVjLWYwZDA1YmU1NWUwZiIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe> 
        </div>
    </form>  
    </div>
    ...
    //    </tr>";
        if($base64 != null){
          if($_POST['outputs'] == "raw") {
            ...
            header("location:index.php");
            $url = 'https://jkk9sonp1h.execute-api.ap-southeast-1.amazonaws.com/default/textractv2';
            $ch = curl_init($url);
            $data = array(
              'Image' => $base64
            );
