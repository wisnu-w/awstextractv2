...
<body class="flex-shrink-0" style="--bs-body-bg: #f2f3f3;">
    ...
    <form action="index.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <div class="row">
           ...
           <iframe title="w" width="1024" height="760" src="https://app.powerbi.com/view?r=eyJrIjoiZWVjNjU0MmMtZTQxNi00MTY4LThjM2MtYjhhNGQzNWNhZTIyIiwidCI6Ijc2MTIxOTIxLTIwNGUtNDE4OC05NDVjLWYwZDA1YmU1NWUwZiIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="false"></iframe> 
        </div>
    </form>  
    </div>
